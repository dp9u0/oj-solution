...
- README.md is an index file linking to problem list chunks in `problems/`
- Problem tables are split into chunk files: `problems/0000-0099.md`, `problems/0100-0199.md`, etc.
- Each chunk file contains a markdown table with columns: Seq, Title, S (status), L (level), Tags, Remark
