...
[LeetCode Problem Description](https://leetcode.com/problems/account-balance-after-rounded-purchase/description/)
...
初始余额100美元，消费金额四舍五入到最近的10的倍数（5向上取整），返回剩余余额。

## 解题思路

roundedAmount = Math.floor((purchaseAmount + 5) / 10) * 10，返回 100 - roundedAmount。
