...
[LeetCode Problem Description](https://leetcode.com/problems/compute-decimal-representation/description/)
...
将正整数n分解为最少数量的十进制分量（一位数字×10的幂），按降序返回。

## 解题思路

按位提取：每个非零位digit × 10^position构成一个分量，逆序输出即为降序。
