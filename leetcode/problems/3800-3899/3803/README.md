...
[LeetCode Problem Description](https://leetcode.com/problems/count-residue-prefixes/description/)
...
给定字符串 s，统计"残基前缀"数量：前缀的不同字符数 == 前缀长度 % 3。

## 解题思路

**Approach: 遍历计数**

1. 遍历字符串，用 Set 维护已见字符
2. 对每个前缀检查 distinct.size == (i+1) % 3
3. 计数即可
