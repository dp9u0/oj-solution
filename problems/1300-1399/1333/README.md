...
[LeetCode Problem Description](https://leetcode.com/problems/filter-restaurants-by-vegan-friendly-price-and-distance/description/)
...
给定餐厅数组[id,rating,veganFriendly,price,distance]，根据veganFriendly、maxPrice、maxDistance过滤，按rating降序（同rating按id降序）返回id数组。
