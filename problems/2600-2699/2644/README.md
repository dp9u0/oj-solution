...
[LeetCode Problem Description](https://leetcode.com/problems/find-the-maximum-divisibility-score/description/)
...
给定 nums 和 divisors 数组，divisors[i] 的整除分数是 nums 中能被其整除的元素个数。返回分数最大的 divisors[i]，相同分数返回最小的。

## 解题思路

暴力枚举每个 divisor，统计 nums 中能整除的个数，维护最大分数和最小除数。
