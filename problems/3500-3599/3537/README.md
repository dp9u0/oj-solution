...
[LeetCode Problem Description](https://leetcode.com/problems/fill-a-special-grid/description/)
...
给定非负整数 `n`，表示一个 2^n × 2^n 的网格。用 0 到 2^(2n) - 1 的整数填充网格使其成为"特殊网格"。
...
**分治递归**：按顺序填充四个象限，序号顺序为：右上 → 右下 → 左下 → 左上。递归时传入起始值和坐标范围。
