...
[LeetCode Problem Description](https://leetcode.com/problems/pythagorean-distance-nodes-in-a-tree/description/)
...
给定一棵树和三个目标节点 x, y, z。对每个节点 u，计算到 x, y, z 的距离 dx, dy, dz。若排序后满足勾股定理 a^2 + b^2 = c^2 则为特殊节点。返回特殊节点数量。

## 解题思路

BFS 分别从 x, y, z 出发计算到所有节点的距离，然后遍历每个节点检查是否满足勾股条件。
