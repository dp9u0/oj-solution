...
```md
https://leetcode.cn/problems/qoQAMX/description/
* algorithms
* Hard (49.34%)
* Likes:    6
* Dislikes: -
...
>返回字典序更小的 `"00110"`
![image.png](https://pic.leetcode.cn/1682319485-cRVudI-image.png){:width=120px}![进化 (3).gif](https://pic.leetcode.cn/1682412701-waHdnm-进化 \(3\).gif){:width=320px}
**示例 2：**
